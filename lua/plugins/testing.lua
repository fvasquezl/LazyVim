return {
  -- Neotest with PHP/Pest/PHPUnit support
  {
    ...
    opts = function(_, opts)
      ...
      opts.discovery    = { enabled = true, concurrent = 1 }
      ...
      opts.status       = { enabled = true, virtual_text = true, signs = true }
  ...
  -- Coverage display
  {
    ...
    cmd = {
      "Coverage", "CoverageLoad", "CoverageLoadLcov",
      "CoverageShow", "CoverageHide", "CoverageToggle", "CoverageSummary",
    },
    keys = {
    ...
    opts = {
      auto_reload = true,
      lang = {
        php = { coverage_file = "coverage/clover.xml" },
      },
      signs = {
  ...
  -- vim-test: alternative runner, useful for running suites via terminal
  {
    "vim-test/vim-test",
    keys = {
